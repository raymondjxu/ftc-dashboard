package net.raymondjxu.ftc.dashboard.config.reflection;

import net.raymondjxu.ftc.dashboard.config.variable.BasicVariable;
import net.raymondjxu.ftc.dashboard.config.variable.ConfigVariable;
import net.raymondjxu.ftc.dashboard.config.variable.CustomVariable;
import net.raymondjxu.ftc.dashboard.config.variable.VariableType;
