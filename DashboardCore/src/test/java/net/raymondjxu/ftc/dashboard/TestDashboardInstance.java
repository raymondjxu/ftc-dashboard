...
import net.raymondjxu.ftc.dashboard.testopmode.TestOpMode;
import net.raymondjxu.ftc.dashboard.testopmode.TestOpModeManager;
            ...
            switch (msg.getType()) {
                case GET_ROBOT_STATUS: {
                    ...
                    send(new ReceiveRobotStatus(
                            new RobotStatus(core.enabled, true, opModeName, opModeStatus, "", "", 12.0, true)
                    ));
                    break;
                }
                case INIT_OP_MODE: {
